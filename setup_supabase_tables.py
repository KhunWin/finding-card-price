"""
Supabase Database Setup Script for Product Key Management
This script creates the necessary tables for server-based product key validation
"""
...
def setup_database():
    """Create tables for product key management"""
    
    print("=" * 70)
    print("  SUPABASE DATABASE SETUP - PRODUCT KEY MANAGEMENT")
    print("=" * 70)
    print()
    ...
    # SQL to create product_keys table
    create_table_sql = """
    ...
    print("⚠️  IMPORTANT: Execute this SQL manually in Supabase SQL Editor")
    print()
    print("Steps:")
    print("1. Go to: https://najsttsptlnqhcupxnbn.supabase.co/project/_/sql")
    print("2. Copy the SQL above")
    print("3. Paste it into the SQL Editor")
    print("4. Click 'Run' to execute")
    print()
    print("After creating the table, run: python3 populate_supabase_keys.py")
    print()
